...
<Note>
This is an archived release-note snapshot. Its Coming Soon section and feature descriptions reflect that historical snapshot, not current availability or commitments. Use the [current release notes](/release-notes/index) and [task guides](/user-guides/getting-started/index) for current instructions.
</Note>
